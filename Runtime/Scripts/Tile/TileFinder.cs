...
//        readonly ConcurrentQueue<Tile> _tileQueue = new();
...
//             {
//                 ITileBuilder tb = new TileCreator();
//                 tb.SetOriginalDirectory(sDirectoryOriginal);
//                 tb.SetIntermediateDirectory(sDirectoryIntermediate);
...
//            // Add to queue
//            _tileQueue.Enqueue(s3km3kmTileName);
//            return TileStatus.QUEUED;
//        }
//    }
//}
